...
{
    public function test_getAdapter_throws_exception_when_arg_is_invalid()
    {
    ...
    public function test_getAdapter_returns_Reducer_instance_for_some_functions()
    {
        self::assertInstanceOf(Min::class, Reducers::getAdapter('min'));
        self::assertInstanceOf(Max::class, Reducers::getAdapter('max'));
    }
    
    public function test_Concat_reducer_accumulates_simple_values_as_string()
    {
