...
{
    public function test_iterate_over_nested_arrays_without_oryginal_keys()
    {
    ...
    public function test_Check_can_validate_param_mode()
    {
    ...
    public function test_Check_throws_exception_when_param_mode_is_invalid()
    {
